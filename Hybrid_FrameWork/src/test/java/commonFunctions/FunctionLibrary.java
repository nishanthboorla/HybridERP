...
public static void typeAcation(String LocatorType,String LocatorValue,String TestData)
{
	if(LocatorType.equalsIgnoreCase("xpath"))
	{
...
// method for click Action to perform action on buttons,images,links,radiobutton, and checkboxes
public static void clickAcation(String LocatorType,String LocatorValue)
{
...
{
	Date date = new Date();
	DateFormat df = new  SimpleDateFormat("YYY_MM_dd");
...
public static void captureStockNum(String LocatorType,String LocatorValue)throws Throwable
{
	...
	if(LocatorType.equalsIgnoreCase("id"))
	{
	 ...
	 FileWriter fw = new FileWriter("./CaputureData/stocknumber.txt");
...
{
	FileReader fr = new FileReader("./CaputureData/stocknumber.txt");
...
FileWriter fw = new FileWriter("./CaputureData/suppliernumber.txt");
BufferedWriter bw = new BufferedWriter(fw);
...
{
	FileReader fr = new FileReader("./CaputureData/suppliernumber.txt");
	BufferedReader br = new BufferedReader(fr);
	String Exp_Data = br.readLine();
	if(!driver.findElement(By.xpath(conpro.getProperty("search-textbox"))).isDisplayed())
		driver.findElement(By.xpath(conpro.getProperty("search-panel"))).click();
...
FileWriter fw = new FileWriter("./CaputureData/customernumber.txt");
BufferedWriter bw = new BufferedWriter(fw);
...
{
	FileReader fr = new FileReader("./CaputureData/customernumber.txt");
	BufferedReader br = new BufferedReader(fr);
	String Exp_Data = br.readLine();
	if(!driver.findElement(By.xpath(conpro.getProperty("search-textbox"))).isDisplayed())
		driver.findElement(By.xpath(conpro.getProperty("search-panel"))).click();
